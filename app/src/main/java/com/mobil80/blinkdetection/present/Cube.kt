...
class Cube {
    ...
    init {
        val vertexShader = GameGLRenderer.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode)
        val fragmentShader =
            GameGLRenderer.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode)
